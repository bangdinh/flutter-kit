import 'package:flutter_kit_example/features/auth/domain/entities/user.dart';
import 'package:flutter_kit_example/features/auth/domain/repositories/auth_repository.dart';
...
class FakeAuthRepository implements AuthRepository {
  ...
  Future<User> login({required String email, required String password}) async {
    ...
    return loginResult ?? User(id: '1', email: email, name: 'Test User');
  }
